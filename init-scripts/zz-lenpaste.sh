...
[ -f "$CONF_DIR/env/lenpaste.script.sh" ] && . "$CONF_DIR/env/lenpaste.script.sh" # Generated by my dockermgr script
[ -f "$CONF_DIR/env/lenpaste.sh" ] && . "$CONF_DIR/env/lenpaste.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
